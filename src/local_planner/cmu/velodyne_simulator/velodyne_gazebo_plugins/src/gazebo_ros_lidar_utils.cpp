...
namespace gazebo {
    ...
    void GazeboRosLidarUtils::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf) {
        ...
        this->trigger_topic_name_ = this->lidar_topic_name_ + "/lidar_trigger";
        ...
        ROS_WARN_STREAM("GazeboRosLidarUtils::Load finished");
    }
    ...
    void GazeboRosLidarUtils::LoadRos() {
        ...
        ROS_INFO_STREAM("this->frame_name_: " << this->frame_name_);
        ...
        if (this->CanTriggerLidar()) {
            ros::SubscribeOptions trigger_so =
                    ros::SubscribeOptions::create<std_msgs::Empty>(
                            ...
                            boost::bind(&GazeboRosLidarUtils::TriggerLidarInternal, this, _1),
                            ros::VoidPtr(), &this->lidar_queue_);
    ...
    void GazeboRosLidarUtils::TriggerLidarInternal(const std_msgs::Empty::ConstPtr &dummy) {
        TriggerLidar();
    }
    ...
    void GazeboRosLidarUtils::LidarConnect() {
        ...
        if ((this->lidar_connect_count_) == 0) {
            ...
            this->gazebo_sub_ = gazebo_node_->Subscribe(
                    this->parentSensor_->Topic(), &GazeboRosLidarUtils::OnScan,this);
        }
   ...
   void GazeboRosLidarUtils::OnScan(const ConstLaserScanStampedPtr &_msg){
    }
}