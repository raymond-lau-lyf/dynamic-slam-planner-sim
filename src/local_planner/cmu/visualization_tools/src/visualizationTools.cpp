...
string metricFile; // NOLINT
string trajFile; // NOLINT
string mapFile; // NOLINT
...
pcl::PointCloud<pcl::PointXYZI>::Ptr laserCloud(new pcl::PointCloud<pcl::PointXYZI>()); // NOLINT
pcl::PointCloud<pcl::PointXYZ>::Ptr overallMapCloud(new pcl::PointCloud<pcl::PointXYZ>()); // NOLINT
pcl::PointCloud<pcl::PointXYZ>::Ptr overallMapCloudDwz(new pcl::PointCloud<pcl::PointXYZ>()); // NOLINT
pcl::PointCloud<pcl::PointXYZI>::Ptr exploredAreaCloud(new pcl::PointCloud<pcl::PointXYZI>()); // NOLINT
pcl::PointCloud<pcl::PointXYZI>::Ptr exploredAreaCloud2(new pcl::PointCloud<pcl::PointXYZI>()); // NOLINT
pcl::PointCloud<pcl::PointXYZI>::Ptr exploredVolumeCloud(new pcl::PointCloud<pcl::PointXYZI>()); // NOLINT
pcl::PointCloud<pcl::PointXYZI>::Ptr exploredVolumeCloud2(new pcl::PointCloud<pcl::PointXYZI>()); // NOLINT
pcl::PointCloud<pcl::PointXYZI>::Ptr trajectory(new pcl::PointCloud<pcl::PointXYZI>());  // NOLINT
...
void odometryHandler(const nav_msgs::Odometry::ConstPtr& odom) {
  ...
  tf::Matrix3x3(tf::Quaternion(geoQuat.x, geoQuat.y, geoQuat.z, geoQuat.w)).getRPY(roll, pitch, yaw);  // NOLINT
  ...
  fprintf(trajFilePtr, "%f %f %f %f %f %f %f\n", vehicleX, vehicleY, vehicleZ, roll, pitch, yaw, timeDuration); // NOLINT
...
void laserCloudHandler(const sensor_msgs::PointCloud2ConstPtr& laserCloudIn) {
  ...
  *exploredVolumeCloud += *laserCloud;
  ...
  exploredVolume = exploredVolumeVoxelSize * exploredVolumeVoxelSize *  // NOLINT
  ...
  *exploredAreaCloud += *laserCloud;
  ...
  fprintf(metricFilePtr, "%f %f %f %f\n", exploredVolume, travelingDis, runtime, timeDuration); // NOLINT
